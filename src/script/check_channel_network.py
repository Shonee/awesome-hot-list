...
PROBES = {
    ...
    "autohome": Probe(lambda: _collect("autohome")),
    "gamersky": Probe(lambda: _collect("gamersky")),
    "ithome": Probe(lambda: _collect("ithome")),
    "yicai": Probe(lambda: _collect("yicai"), minimum=3),
    "yicai-live": Probe(lambda: count_snapshot_items(collect_channel("yicai", surface="live"))),
