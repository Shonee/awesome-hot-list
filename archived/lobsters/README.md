...
15. [F-Droid 2.0](https://f-droid.org/2026/09/24/f-droid-2.0-a-new-chapter-for-android-freedom.html)
16. [I asked Meta’s Muse for its filesystem and it sent me 6.8 GB](https://mouse.dev/blog/muse-runtime-export/)
17. [LLM Policies: Progress At All Costs](https://diegoe.be/2026/09/25/llm-policies-progress-at-all-costs/)
18. [Cross-Site Scripting (XSS) Cheat Sheet](https://portswigger.net/web-security/cross-site-scripting/cheat-sheet)
...
21. [Understanding NvPCRs in systemd v262](https://katexochen.aro.bz/posts/systemd-v262-nvpcrs/)
22. [weave: structural merging for different languages](https://github.com/Ataraxy-Labs/weave)
23. [Pencils Down, Eyes Open: A Rails Developer After Rails World](https://caio.ca/blog/pencils-down-eyes-open-rails-world)
24. [How to keep enjoying programming in a world of LLMs](https://discourse.haskell.org/t/how-to-keep-enjoying-programming-in-a-world-of-llms/14705)
